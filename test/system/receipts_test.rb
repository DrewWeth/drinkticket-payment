...
class ReceiptsTest < ApplicationSystemTestCase
  ...
  test "creating a Receipt" do
    ...
    fill_in "Pay amount", with: @receipt.pay_amount
    fill_in "Payer", with: @receipt.payer
    fill_in "Payer", with: @receipt.payer_id
    fill_in "Source created at", with: @receipt.source_created_at
    fill_in "Source", with: @receipt.source_id
